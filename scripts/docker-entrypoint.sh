...
exec sh -c "java -Xshare:off -XX:ArchiveClassesAtExit=$APP_CDS_PATH $STARTUP_JAVA_OPTS $BASE_JAVA_OPTS -Dserver.port=$PORT_VALUE -Dfile.encoding=UTF-8 -jar $APP_JAR"
