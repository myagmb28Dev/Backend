...
public class BookmarkController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> add(@PathVariable String noticeId) {
        Map<String, Object> data = bookmarkService.addBookmark(noticeId);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> remove(@PathVariable String noticeId) {
        Map<String, Object> data = bookmarkService.removeBookmark(noticeId);
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> list() {
        List<Map<String, Object>> data = bookmarkService.getMyBookmarks();
