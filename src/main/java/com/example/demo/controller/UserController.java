...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getProfile() {
        Map<String, Object> data = userService.getProfile();
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> myPosts() {
        List<Map<String, Object>> data = userService.myPetNotices();
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> myCommunityPosts() {
        List<Map<String, Object>> data = userService.myCommunityPosts();
