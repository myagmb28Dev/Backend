...
@Getter
@Setter
@Schema(description = "Missing pet notice create request")
public class MissingPetCreateRequest {
    @NotBlank
    @Schema(description = "Notice title", example = "Looking for my maltese")
    ...
    @PositiveOrZero
    @Schema(description = "Reward amount", example = "300000")
